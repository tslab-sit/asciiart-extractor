...
public class RLSKsNgJ48 implements Recognizer {
	private J48 recognizer;
	private RLSKsNgAttributesFactory attrFactory;

	public RLSKsNgJ48(J48 recognizer, KskipNgramCounter ngramCounter) {
		this.recognizer = recognizer;
		this.attrFactory = new RLSKsNgAttributesFactory(ngramCounter);
	}
	...
	Instance getInstance(RLSKsNgAttributes attr) {
	...
	public boolean isASCIIArt(Window window) {
		...
		RLSKsNgAttributes attr = this.attrFactory.create(window);
