...
public class RLSNgARFFDataSetPrinter implements RLSNgDataSetPrinter {
...
//	public static final String ngramAttr = "ngram";
...
//	public static final String notTextartClassName = "not_textart";
	...
	public void printAttributes(String cls, RLSNgAttributes attr) {
		String[] elm = {attr.getR()+"", attr.getL()+"", attr.getS()+"", attr.getNg()+"", cls};
