...
public class RRvwLSJ48 implements Recognizer {
	private J48 recognizer;
	private RRvwLSAttributesFactory attrFactory;
	public RRvwLSJ48(J48 recognizer) {
		this.recognizer = recognizer;
		this.attrFactory = new RRvwLSAttributesFactory();
	}
	...
	Instance getInstance(RRvwLSAttributes attr) {
